...
public class AutoScaler {
    ...
    private static final double MAX_THRESHOLD = 80.0; // CPU utilization %
    ...
    private double getAverageCpuUtilization() {
        ...
        for (String instanceId : loadBalancer.availableInstances) {
            ...
            System.out.println("CPU utilization for instance " + instanceId + " = " + datapoints.getAverage());

            if (!datapoints.isEmpty()) {
                totalCpuUtilization += datapoints.get(0).getAverage();
            }
        }
